...
#include <stdlib.h> // Required for dynamic memory allocation using malloc and free

// Function: new_node
// Purpose: Dynamically allocates memory for a new node in the linked list,
//          initializes it with the provided value, and sets its next pointer to NULL.
